    ...
    <div className="flex justify-center mt-10 mb-20">
      <div style={{ width: "70%" }}>
        <p className="text-justify">
          <h1 className="text-2xl font-bold mb-8">Rent'Alpes Privacy Policy</h1>
          <p>
            This Privacy Policy describes how your personal information is
            collected, used, and shared when you visit or rent from
            https://rent-alpes-6b66d.firebaseapp.com/ (the “Site”).
          </p>
          <h2 className="text-1xl font-bold mb-8 mt-10">
          ...
          record information about how you browse the Site. Additionally when
          you rent or attempt to rent through the Site, we collect certain
          ...
          <h2 className="text-1xl font-bold mb-8 mt-10">DO NOT TRACK</h2>
          Please note that we do not alter our Site’s data collection and use
          practices when we see a Do Not Track signal from your browser.
          <h2 className="text-1xl font-bold mb-8 mt-10">YOUR RIGHTS</h2>
          ...
          <h2 className="text-1xl font-bold mb-8 mt-10">DATA RETENTION</h2>
          When you place an order through the Site, we will maintain your Order
          Information for our records unless and until you ask us to delete this
          information.
          <h2 className="text-1xl font-bold mb-8 mt-10">MINORS</h2>
          The Site is not intended for individuals under the age of 18.
          <h2 className="text-1xl font-bold mb-8 mt-10">CHANGES</h2>
          We may update this privacy policy from time to time in order to
          reflect, for example, changes to our practices or for other
          operational, legal or regulatory reasons.
          <h2 className="text-1xl font-bold mb-8 mt-10">CONTACT US</h2>
          For more information about our privacy practices, if you have
          questions, or if you would like to make a complaint, please contact us
          by e-mail at pablocallejo@gmail.com or by mail using the details
          provided below: 280 Rue Jean Cochet, 32B, Faverges Seythenex, ARA,
          74210, France
        </p>
      </div>
    </div>
